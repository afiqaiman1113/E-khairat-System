                            ...
                            <div class="card card">
                                ...
                                <div class="card-body">
                                    <form action="" method="POST" name="" enctype="multipart/form-data">
                                        ...
                                        <input type="hidden" name="status_tuntut" class="form-control" value="2" />
                                        <div class="row">
                                            <div class="col-md-12">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group date" data-target-input="nearest">
                                                        ...
                                                        <input type="date" class="form-control" name="tarikh_mati" id="tarikh_mati" required="" oninvalid="this.setCustomValidity('Pilih tarikh')" oninput="setCustomValidity('')">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" name="no_surat" class="form-control" placeholder="" required="" oninvalid="this.setCustomValidity('Wajib Isi')" oninput="setCustomValidity('')" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="jumlah" class="form-control" id="jumlah" required="" oninvalid="this.setCustomValidity('Isi')" oninput="setCustomValidity('')" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" name="no_cek" class="form-control" placeholder="Jika Ada" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" name="nota" class="form-control" placeholder="Jika Ada" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
