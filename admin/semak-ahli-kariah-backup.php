                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="email" id="penama_email" name="penama_email" class="form-control" placeholder="" value="<?php echo $row_penama['penama_email']; ?>" required="required" oninvalid="InvalidMsg(this);" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="penama_no" id="penama_no" class="form-control" value="<?php echo $row_penama['penama_no']; ?>" placeholder="Tiada Dash (-)" required="required" pattern="^(\+?6?01)[0-46-9]-*[0-9]{7,8}$" oninvalid="InvalidPhonePenama(this);" oninput="InvalidPhonePenama(this);" />
                                        </div>
                                    </div>
                                </div>
                            </div>
