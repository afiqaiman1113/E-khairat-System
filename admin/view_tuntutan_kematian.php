<div class="modal fade" id="edit_<?php echo $row->tuntut_id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                <div class="container-fluid">
                    <dl>
                        ...
                        <dd class="text-muted"><?php echo $row->no_ahli; ?></dd>
                        <dt class="text-muted"><b>Si Mati</b></dt>
                        <dd class="text-muted"><span style="text-transform:uppercase"><?php echo $row->tuntut_name; ?></dd>
                        <dt class="text-muted"><b>No Kad Pengenalan</b></dt>
                        <dd class="text-muted"><?php echo $row->tuntut_ic; ?></dd>
                        ...
                        <dt class="text-muted"><b>Si Penuntut</b></dt>
                        ...
                        <dd class="text-muted"><?php echo $row->hubungan; ?></dd>
                        ...
                        ?>
                            <ul class="list-group">
                                <img src="productimages/<?php echo $row->tuntut_image; ?> " class="img-responsive" />
                            </ul>
                        <?php
                        }
                        ?>
