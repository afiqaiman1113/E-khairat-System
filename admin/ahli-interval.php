                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <?php
                                        if (strtotime(date("d-m-Y")) < strtotime($tarikh_tamat)) {
                                            ...
                                            $update_kariah = $pdo->prepare("UPDATE ahli_kariah SET status_sms=0 WHERE kariah_id = $id");
                        ...
                        <div class="row">
                            ...
                            if ($kariah_umur == NULL) {
                                echo '
                                       <div class="col-md-6">
                                        ...
                                        <label style="color:red;">* <span style="color:black;">Umur</span></label>
                                            <div class="input-group">
                                                <input type="text" name="kariah_umur" class="form-control" placeholder="Belum Dikemaskini" value="" readonly />
                                            </div>
                                        </div>
                                    </div>';
                            } else {
                                ...
                                echo '
                                    ...
                                    <label style="color:red;">* <span style="color:black;">Umur</span></label>
                                        <div class="input-group">
                                            <input type="text" name="kariah_umur" class="form-control" placeholder="" value=" ' . $umurkariah . ' " readonly />
                                        </div>
                                    </div>
                                </div>
                                    ';
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Emel</label>
                                    <div class="input-group">
                                        <input type="email" name="user_email" class="form-control" placeholder="" value="<?php echo $user_email; ?>" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="penama_name" class="form-control" style="text-transform: uppercase" placeholder="" value="<?php echo $row_penama['penama_name']; ?>" required="" oninvalid="this.setCustomValidity('Wajib isi')" oninput="setCustomValidity('')" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label style="color:red;">* <span style="color:black;">No K/P</span></label>
                                    <div class="input-group">
                                        <input type="text" name="penama_ic" id="penama_ic" class="form-control" placeholder="" value="<?php echo $row_penama['penama_ic']; ?>" required="" oninvalid="this.setCustomValidity('Wajib isi')" oninput="setCustomValidity('')" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <!-- <div class="col-md-6">
                                <div class="form-group">
                                    <label>Emel</label>
                                    <div class="input-group">
                                        <input type="email" name="penama_emel" class="form-control" placeholder="" required="" oninvalid="this.setCustomValidity('Wajib isi')" oninput="setCustomValidity('')" />
                                    </div>
                                </div>
                            </div> -->
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="penama_no" class="form-control" style="text-transform: uppercase" placeholder="" value="<?php echo $row_penama['penama_no']; ?>" required="" oninvalid="this.setCustomValidity('Wajib isi')" oninput="setCustomValidity('')" />
                                    </div>
                                </div>
                            </div>
                        </div>
