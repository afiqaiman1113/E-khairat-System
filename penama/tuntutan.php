...
$select = $pdo->prepare("SELECT * FROM tuntut INNER JOIN ahli_kariah ON tuntut.kariah_id = ahli_kariah.kariah_id INNER JOIN penama ON tuntut.kariah_id = penama.kariah_id WHERE tuntut.tuntut_id = $id");
$select->execute();
$row = $select->fetch(PDO::FETCH_OBJ);

$select1 = $pdo->prepare("SELECT tuntut.jumlah FROM tuntut INNER JOIN ahli_kariah ON tuntut.kariah_id = ahli_kariah.kariah_id INNER JOIN penama ON tuntut.kariah_id = penama.kariah_id WHERE tuntut.tuntut_id = $id");
$select1->execute();
