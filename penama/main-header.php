...
<div class="main-header">
    ...
    <div class="logo-header" data-background-color="dark">
        ...
        <a href="penama.php?p=utama1" class="logo">
                        ...
                        <div class="dropdown-user-scroll scrollbar-outer">
                            <li>
                                <div class="user-box">
                                    ...
                                    <div class="u-text">
                                        <h4 style="text-transform: uppercase"><?php echo $row->penama_name; ?></h4>
                            ...
                            <li>
                                ...
                                <a class="dropdown-item" href="penama.php?p=member">Tukar Kata Laluan</a>
                                <div class="dropdown-divider"></div>
